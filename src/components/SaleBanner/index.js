    ...
    return (
        ...
        >
            <View style={styles.contentContainer}>
                {/* <Text style={styles.saleText}>Laptop Sale</Text>
                <Text style={styles.sloganText}>Unleash Your Productivity, Anywhere</Text>
                <Text style={styles.discountText}>Up to 50% OFF</Text> */}
                <Animated.Text style={[styles.saleText, { color: interpolatedColors }]}>{saleText}</Animated.Text>
                <Animated.Text style={[styles.sloganText, { color: interpolatedColors }]}>
                    {sloganText}
                </Animated.Text>
                <Animated.Text style={[styles.discountText, { color: interpolatedColors }]}>{discountText}</Animated.Text>
            </View>
