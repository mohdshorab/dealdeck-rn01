...
import { Image, SafeAreaView, ScrollView, StyleSheet, Text, View, TouchableOpacity, ActivityIndicator, Alert, RefreshControl, TextInput, Button } from "react-native";
        ...
        <SafeAreaView style={styles.container} >
            ...
            >
                ...
                <View style={styles.subContainer} >
                    <View style={{backgroundColor: '#EAEDFF', paddingVertical:10, borderRadius:10, }} >
                    ...
                    <Text style={{ fontWeight: '600', marginTop: 10 }} >Check the product availability at your pincode.</Text>
                    ...
                    <SaleBanner
                        ...
                        floatingImage1Styles={{ height: 200, width: 200, top: -75, right: -25 }}
...
const styles = StyleSheet.create({
    ...
    straightLine: { borderWidth: 0.5, borderBottomColor: 'grey', marginTop: 15, shadowOpacity: 1 },
    ...
    similarProductsText: { fontSize: 15, marginBottom: 10, marginTop: 10, fontWeight: '900', color: '#01BFFF' },
    descriptionText: { marginTop: 10, fontSize: 15, color: '#506AE6', fontWeight: 'bold',},
    emiText: { fontSize: 15, },
    ...
    optionContainer: { flex: 1, flexDirection: 'row', justifyContent: 'space-evenly', marginTop: 10 },
    buttonContainer: { flex: 1, flexDirection: "row", position: "absolute", bottom: 0, width: '100%', alignContent: "space-between", borderTopWidth: 1, borderBottomWidth: 1 },
